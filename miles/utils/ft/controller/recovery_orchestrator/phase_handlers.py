...
from miles.utils.ft.controller.recovery_orchestrator.context import PENDING_TIMEOUT_SECONDS, RecoveryContext
from miles.utils.ft.controller.recovery_orchestrator.helpers import retry_async, safe_notify, stop_clear_submit
...
async def _reattempt_poll(
    ...
    if status == JobStatus.RUNNING:
        ...
        ctx.reattempt_base_iteration = int(iteration) if iteration is not None and math.isfinite(iteration) else 0
