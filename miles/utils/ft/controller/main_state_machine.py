...
class MainStepper(StateMachineStepper[MainState, TickContext]):
    def __init__(
        ...
        *,
        ...
        recovery_stepper: StateMachineStepper[RecoveryState, RecoveryContext],
        restart_stepper: StateMachineStepper[RestartState, RestartContext],
    ...
    def _build_restart_context(self) -> RestartContext:
        ...
        return RestartContext(
            ...
            monitoring_success_iterations=self._monitoring_success_iterations,
            monitoring_timeout_seconds=self._monitoring_timeout_seconds,
        )

    def _build_recovery_context(self, *, trigger: TriggerType, recovery_start_time: datetime) -> RecoveryContext:
        deps = self._platform_deps
        return RecoveryContext(
            ...
            restart_context=self._build_restart_context(),
            notifier=deps.notifier,
