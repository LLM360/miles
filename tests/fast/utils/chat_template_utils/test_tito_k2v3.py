...
def tokenizer() -> AutoTokenizer:
    ...
    return load_tokenizer(
        K2V3_MODEL_PATH,
        chat_template_path=resolve_fixed_chat_template(TITOTokenizerType.K2V3)[0],
...
def test_k2v3_subclass_is_wired(tito_tok):
    ...
    assert isinstance(tito_tok, K2V3TITOTokenizer), (
        ...
        f"TITOTokenizerType.get_tokenizer_class(TITOTokenizerType.K2V3) may be misregistered."
    )
